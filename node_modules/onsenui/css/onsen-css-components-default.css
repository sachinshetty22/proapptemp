...
input:checked + .switch__toggle {
  -webkit-box-shadow: inset 0 0 0 2px #50ade3;
  box-shadow: inset 0 0 0 2px #50ade3;
...
.switch.switch--material.switch--active input:checked + .switch__toggle .switch__handle:before {
  -webkit-box-shadow: 0px 0px 0px 14px rgba(80,173,227,0.2);
  box-shadow: 0px 0px 0px 14px rgba(80,173,227,0.2);
}
...
.range {
  ...
  border-radius: 3px;
  background-image: -webkit-gradient(linear, left top, left bottom, from(#303a44), to(#303a44));
  background-image: -webkit-linear-gradient(#303a44, #303a44);
  background-image: -moz-linear-gradient(#303a44, #303a44);
  background-image: -o-linear-gradient(#303a44, #303a44);
  background-image: linear-gradient(#303a44, #303a44);
...
.range--material::-webkit-slider-thumb {
  ...
  background-image: -webkit-radial-gradient(7px, circle 6px, #50ade3 0%, #50ade3 6px, transparent 7px);
  background-image: radial-gradient(circle 6px at 7px, #50ade3 0%, #50ade3 6px, transparent 7px);
  margin-top: -1px;
}
...
.button--outline {
  background-color: transparent;
  border: 1px solid #467a9a;
  color: #467a9a;
}
.button--outline:active {
  background-color: rgba(70,122,154,0.2);
  border: 1px solid #467a9a;
  color: #467a9a;
  opacity: 1;
}
...
:checked + .tab-bar--top-border__button {
  background-color: transparent;
  border-bottom: 4px solid #50ade3;
}
.tab-bar--material {
  background-color: #1f2933;
...
.list__item__center {
  ...
  background-repeat: no-repeat;
  background-position: bottom;
  background-image: -webkit-linear-gradient(90deg, #303a44, #303a44 100%);
  background-image: -moz-linear-gradient(90deg, #303a44, #303a44 100%);
  background-image: -o-linear-gradient(90deg, #303a44, #303a44 100%);
  background-image: linear-gradient(0deg, #303a44, #303a44 100%);
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .list__item__center {
    background-image: -webkit-linear-gradient(90deg, #303a44, #303a44 50%, transparent 50%);
    background-image: -moz-linear-gradient(90deg, #303a44, #303a44 50%, transparent 50%);
    background-image: -o-linear-gradient(90deg, #303a44, #303a44 50%, transparent 50%);
    background-image: linear-gradient(0deg, #303a44, #303a44 50%, transparent 50%);
  }
}
.list__item__right {
  -webkit-box-sizing: border-box;
...
.list__item:first-child {
  -webkit-box-shadow: inset 0px 1px 0px 0px #303a44;
  box-shadow: inset 0px 1px 0px 0px #303a44;
  margin-top: 0;
}
...
.text-input--material:focus {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#50ade3), to(#50ade3)), -webkit-gradient(linear, left bottom, left top, color-stop(1px, transparent), color-stop(1px, #4c4c4c));
  background-image: -webkit-linear-gradient(#50ade3, #50ade3), -webkit-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -moz-linear-gradient(#50ade3, #50ade3), -moz-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: -o-linear-gradient(#50ade3, #50ade3), -o-linear-gradient(bottom, transparent 1px, #4c4c4c 1px);
  background-image: linear-gradient(#50ade3, #50ade3), linear-gradient(to top, transparent 1px, #4c4c4c 1px);
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .alert-dialog-button {
    ...
    background-repeat: no-repeat;
    background-position: top;
    background-image: -webkit-linear-gradient(270deg, #3e4c59, #3e4c59 50%, transparent 50%);
    background-image: -moz-linear-gradient(270deg, #3e4c59, #3e4c59 50%, transparent 50%);
    background-image: -o-linear-gradient(270deg, #3e4c59, #3e4c59 50%, transparent 50%);
    background-image: linear-gradient(180deg, #3e4c59, #3e4c59 50%, transparent 50%);
  }
}
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .alert-dialog-button--one {
    ...
    background-image: -webkit-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%), -webkit-linear-gradient(0deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: -moz-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%), -moz-linear-gradient(0deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: -o-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%), -o-linear-gradient(0deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: linear-gradient(0deg, transparent, transparent 50%, #3e4c59 50%), linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%);
  }
}
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
  .alert-dialog-button--one:first-child {
    ...
    background-repeat: no-repeat;
    background-position: top, left;
    background-image: -webkit-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: -moz-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: -o-linear-gradient(90deg, transparent, transparent 50%, #3e4c59 50%);
    background-image: linear-gradient(0deg, transparent, transparent 50%, #3e4c59 50%);
  }
}
.alert-dialog-mask {
  padding: 0;
...
.popover__arrow {
  ...
  background-color: transparent;
  background-image: -webkit-linear-gradient(45deg, #263b4c, #263b4c 50%, transparent 50%);
  background-image: -moz-linear-gradient(45deg, #263b4c, #263b4c 50%, transparent 50%);
  background-image: -o-linear-gradient(45deg, #263b4c, #263b4c 50%, transparent 50%);
  background-image: linear-gradient(45deg, #263b4c, #263b4c 50%, transparent 50%);
...
.modal {
  ...
  font-size: 17px;
  overflow: hidden;
  background-color: rgba(38,59,76,0.37);
  position: absolute;
  left: 0;
  right: 0;
  top: 0;
